...
export const Spotlight = () => {
  ...
  return (
    <div id="home" className="relative w-full h-screen bg-gradient-to-br from-black via-gray-900 to-black flex flex-col items-center justify-center text-center text-white px-4">
      ...
      <button
        onClick={projectView}
        className="px-8 py-3 bg-gradient-to-r from-blue-800 to bg-blue-400 cursor-pointer hover:bg-blue-600 transition-colors duration-300 rounded-full text-white font-semibold text-lg shadow-lg"
      >
        View Projects
      </button>
